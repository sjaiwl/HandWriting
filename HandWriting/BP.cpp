...
{  
	...
	int i,j;  
	//隐含结点权值写入  
	if(( stream0 = fopen("BP\\w.txt", "w+" ))==NULL)  
	{  
		cout<<"创建文件失败!";  
		exit(1);  
	}  
	...
	//输出结点权值写入  
	if(( stream1 = fopen("BP\\w1.txt", "w+" ))==NULL)  
	{  
		cout<<"创建文件失败!";  
		exit(1);  
	}  
	...
	//隐含结点阀值写入  
	if(( stream2 = fopen("BP\\b1.txt", "w+" ))==NULL)  
	{  
		cout<<"创建文件失败!";  
		exit(1);  
	}  
	...
	//输出结点阀值写入  
	if(( stream3 = fopen("BP\\b2.txt", "w+" ))==NULL)  
	{  
		cout<<"创建文件失败!";  
		exit(1);  
	}  
...
{  
	...
	//隐含结点权值读出  
	if(( stream0 = fopen("BP\\w.txt", "r" ))==NULL)  
	{  
		cout<<"打开文件失败!";  
		exit(1);  
	}  
	...
	//输出结点权值读出  
	if(( stream1 = fopen("BP\\w1.txt", "r" ))==NULL)  
	{  
		cout<<"打开文件失败!";  
		exit(1);  
	}  
	...
	//隐含结点阀值读出  
	if(( stream2 = fopen("BP\\b1.txt", "r" ))==NULL)  
	{  
		cout<<"打开文件失败!";  
		exit(1);  
	}  
	...
	//输出结点阀值读出  
	if(( stream3 = fopen("BP\\b2.txt", "r" ))==NULL)  
	{  
		cout<<"打开文件失败!";  
		exit(1);  
	}  
